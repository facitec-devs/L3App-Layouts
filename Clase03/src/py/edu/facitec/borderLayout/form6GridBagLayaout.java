 ...
 * @author Jorge Fabio
 */
public class form6GridBagLayaout extends javax.swing.JFrame {

    /**
     * Creates new form form6GridBagLayaout
     */
    public form6GridBagLayaout() {
        initComponents();
    }
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(form6GridBagLayaout.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new form6GridBagLayaout().setVisible(true);
            }
        });
    }
